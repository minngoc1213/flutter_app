...
import 'package:flutter_application_2/features/categories/data/repositories/get_categories_repositoryImpl.dart';
...
class GetCategoriesUseCase extends UseCase<CategoryEntities, NoParams> {
  final GetCategoriesRepositoryImpl getCategoriesRepositoryImpl;
