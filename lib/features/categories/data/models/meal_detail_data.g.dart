...
_MealDetailData _$MealDetailDataFromJson(Map<String, dynamic> json) =>
    _MealDetailData(
      meals:
          (json['meals'] as List<dynamic>?)
              ?.map(
                (e) =>
                    MealDetailElementData.fromJson(e as Map<String, dynamic>),
              )
              .toList() ??
          const [],
    );

Map<String, dynamic> _$MealDetailDataToJson(_MealDetailData instance) =>
    <String, dynamic>{'meals': instance.meals};

_MealDetailElementData _$MealDetailElementDataFromJson(
...
Map<String, dynamic> _$MealDetailElementDataToJson(
  _MealDetailElementData instance,
) => <String, dynamic>{
