    ...
    return Scaffold(
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            SizedBox(height: 28,),
              Text("Sign Up", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w600, color: AppColors.redPink),),
              Spacer(),
            ...
            CustomTextField(
              onTap: () async {
                DateTime? dob = await showDatePicker(context: context, firstDate: DateTime(1900), lastDate: DateTime.now());
                if (dob != null) {
